...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER CUSTOMER1</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER CUSTOMERs</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                                        </div><div id="responsediv" class="alert alert-dismissable alert-danger"></div>';
     	  $content .='<div class="form-group">
...
function membersList($type, $mem_no, $mem_name, $start,$branch_id)
{
	...
	{				    	    
		$content .= '<div class="panel panel-default" id="demo" style="overflow:scroll;">
                            <div class="panel-heading">
                                <p><h5 class="text-primary mt0">LIST OF&nbsp;'.$head.'</h5></p>
                                
                            </div>';
 		$content .= '<table class="table table-striped table-bordered" id="table-tools">';
 		$content .= '<thead><th>#</th><th>NAME</th><th>MEMBER NO.</th><th>AGE</th><th>SEX</th><th>PHONE NO.</th><th>PHYSICAL ADDRESS</th><th>NEXT OF KIN</th><th>NEXT OF KIN PHONE NO.</th><th>PHOTO</th><th>SIGNATURE</th><th>EDIT</th></thead><tbody>';
