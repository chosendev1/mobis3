...
$xajax->registerFunction("set_bank_balance");


function addReceivableForm($prefix1, $prefix2)
{       $fixed_acc ="";
	$resp = new xajaxResponse();
	//$fix = @mysql_query("select account_id, id from receivable order by id");
	$level1 = @mysql_query("select id, account_no, name from accounts where account_no like '".$prefix."%' and (account_no >= ".$prefix1."01 and account_no <= ".$prefix1."99) or (account_no >= ".$prefix2."01 and account_no <= ".$prefix2."99)");
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER RECEIVABLE</h4>
		                     ...
		                     $content .= '<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                           <input type="numeric" id="intval" name="initval"  class="form-control">
                                            </div></div>';
...
$content = '<div class="row">
	...
	$content .= "<div class='panel-footer'>                              
                                ...
                                <input type='button' class='btn  btn-primary' value='Search' onclick=\"xajax_listReceivables('".$type."', getElementById('account').value, getElementById('from_date').value, getElementById('to_date').value, getElementById('branch_id').value)\">
                            </div>
                        </form>
                        <!--/ Form default layout -->
                    </div>";
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                        ...
                                        $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Initial Amount Due:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" id="initval" name="initval" value="'.$row['amount'].'" class="form-control">
                                            </div></div>';
