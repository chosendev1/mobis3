...
{       $fixed_acc='';
	...
	$level1 = @mysql_query("select id, account_no, name from accounts where account_no like '123%' and account_no >= 1231 and account_no <= 1239 ");
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER FIXED ASSET</h4>
                                         ...
                                         '.branch_rep($branch_id).'
                                          ...
                                          <select id="acc_id" name="acc_id" class="form-control">'.$fixed_acc.'</select>
                                            ...
                                            <label class="col-sm-3 control-label">Select Bank Account:</label>
                                            <div class="col-sm-6">
                                           <select name="bank_acct_id" id="bank_acct_id" class="form-control">'.$accts.'</select>
                                            ...
                                            <div class="col-sm-6">
                                          <input type="numeric" name="initval" id="initval" class="form-control">
                                            </div></div>';
                                            
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Rate of depreciation:</label>
                                            <div class="col-sm-6">
                                          <input type="numeric" name="deprate" id="deprate" class="form-control">
                                            ...
                                            <button type='button' class='btn btn-primary' onclick=\"xajax_addFixedAsset(document.getElementById('acc_id').value, document.getElementById('initval').value, document.getElementById('deprate').value, document.getElementById('bank_acct_id').value, document.getElementById('date').value,document.getElementById('branch_id').value); return false;\">Save</button>";
...
function addFixedAsset($acc_id, $initval, $deprate, $bank_acct_id, $date,$branch_id)
{     
	...
	else
	{
		...
		*/
		start_trans();
		$res = @mysql_query("insert into fixed_asset (account_id, initial_value, dep_percent, bank_account, date, next_dep_date,branch_id) values ($acc_id, $initval, $deprate, $bank_acct_id, '".$date."', '".$nxt_dep_date."',".$branch_id.")");
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="panel panel-default" action="">
                            <div class="panel-heading">
                                <p><h5 class="semibold text-primary mt0 mb5">LIST OF FIXED ASSETS</h5></p>
                            </div>               
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5"></h4>                                               	 
                                           	 </div>
                                        </div>';                                        
	                                ...
	                                $content .= '<div class="form-group">
                                       ...
                                       $content .= "<div class='panel-footer'><button type='reset' class='btn btn-default' onclick=\"xajax_listFixedAssets('".$type."', '".$from_date."','".$to_date."', '".$branch_id."')\">Back</button>
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                            ...
                                            <label class="col-sm-3 control-label">Initial Value:</label>
                                            <div class="col-sm-6">
                                          <input type="numeric" name="initval" id="initval" class="form-control" value="'.$row['initial_value'].'">
                                            </div></div>';
...
function updateFixedAsset2($assetid,$asset_name,$deprate,$initval,$date,$type,$from_date,$to_date, $branch_id)
{       
	...
	else
	{
		...
		$resp->call('xajax_updateFixedAsset', $assetid, $asset_name, $deprate, $initval, $date, $type,$from_date,$to_date, $branch_id);
	}
	return $resp;
}

function updateFixedAsset($assetid, $asset_name, $deprate, $initval, $date, $type,$from_date,$to_date, $branch_id)
{       list($year,$month,$mday) = explode('-', $date);
	$resp = new xajaxResponse();
	//$date = sprintf("%d-%02d-%02d", $date);
	$yeardays = ($year % 4 == 0 && ($year % 100 != 0 || $year % 400 == 0)) ? 366 : 365;
	...
	$res = @mysql_query("update fixed_asset set date='".$date."', next_dep_date='".$nxt_dep_date."', dep_percent='".$deprate."', initial_value=$initval where id=$assetid");
	...
	if (@mysql_affected_rows() > 0){
		...
		$cont = "<font color=red><b>ERROR: ".$asset_name." not updated!</b></font><br>";
	$resp->assign("status", "innerHTML", $cont);
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">SELL FIXED ASSET</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                                        </div>';
