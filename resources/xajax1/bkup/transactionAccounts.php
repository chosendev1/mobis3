...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h5 class="semibold text-primary mt0 mb5">TRANSFER CASH FROM ONE ACCOUNT TO ANOTHER</h5>
...
$content .= '<div class="panel-body pt0 pb0">
	...
	$content .= '<div class="form-group">
                                            ...
                                            <label class="col-sm-3 control-label">Select Account(From Chart of Accounts):</label>
                                            <div class="col-sm-6">
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">POST A SCHEDULE</h4>
                                               		 <div class="alert alert-warning">The excel file should have the columns: MemberNo, Shares, then the Account Codes  of the transactions <br>The file should have the etension .xls</div>
                                           	 </div>
                                        </div>';
					    ...
					    <div id="branchDiv">
                                           ...
                                           <input type="numeric" class="form-control" name="contact" id="contact">
                                             ...
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">File Ref:</label>
                                            <div class="col-sm-6">
                                           ...
                                           <input type="numeric" name="cheque_no" id="cheque_no" class="form-control">
                                            ...
                                            <label class="col-sm-3 control-label">Date:</label>
                                            <div class="col-sm-6">
                                           <span><input type="text" class="form-control" name="date" id="date" value="'.date('Y-m-d').'"></span>
                                            </div></div>';
                                            $resp->call("createDate","date");
...
function list_bulk($file_ref, $from_date,$to_date){
	...
	$content .= "<div class='panel-footer'>                              
                                ...
                                <input type='button' class='btn  btn-primary' value='Show Report'  onclick=\"xajax_list_bulk(getElementById('file_ref').value, getElementById('from_year').value, getElementById('from_month').value, getElementById('from_mday').value, getElementById('to_year').value, getElementById('to_month').value, getElementById('to_mday').value);\">
                            </div>
                        </form>
                        <!--/ Form default layout -->
                    </div>";
	...
	if(mysql_numrows($sth) >0){
	 ...
	 $content .= '<div class="panel panel-default" id="demo">
 		...
 		$content .= '<table class="table table-striped table-bordered" id="table-tools">';
		$content .= "<thead><th><b>Date</b></th><th><b>File Reference</b></th><ths><b>Total Amt</b></th><th><b>Contact</b></th><th><b>Action</b></th><th><b></b></th></tr>";
		$grand = 0;
		while($row = mysql_fetch_array($sth)){
		...
		$content .= "<tr><td colspan=2></td><td colspan=3>".number_format($grand, 2)."</td></tr>";
	}
	else{  
