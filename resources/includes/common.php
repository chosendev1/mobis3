...
function branch_rep($branch_id){
	...
	$content = "<select name='branch_id' id='branch_id' class='form-control'><option value='all' label='".$branchName."'>".$branchName."<option value='all' label=' --All Branches-- '> --All Branches-- ";
	while($row = mysql_fetch_assoc($branch)){
		$content .="<option value='".$row['branch_no']."' label='".$row['branch_name']."'>".$row['branch_name'];
	}
	$content .="</select>";
