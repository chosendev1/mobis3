...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h5 class="semibold text-primary mt0 mb5">TRANSFER CASH FROM ONE ACCOUNT TO ANOTHER</h5><div><font color="#FF0000">*</font> - Required.</div>
                                  ...
                                  $sth = mysql_query("select b.id, b.bank, a.account_no, a.name from bank_account b join accounts a on b.account_id=a.id order by a.account_no");      
	                                    ...
	                                    $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Source Account <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6"><select name="source_id" id="source_id"  class="form-control"><option value="">';
	...
	$content .='</select></div>                                            
                                   ...
                                   $sth = mysql_query("select b.id, b.bank, a.account_no, a.name from bank_account b join accounts a on b.account_id=a.id order by a.account_no");                                                   
                                            ...
                                            <label class="col-sm-3 control-label">Destination Account <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
	...
	$content .='</select>	
                                            ...
                                            <label class="col-sm-3 control-label">Amount <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="int" id="amount" name="amount" class="form-control">
                                            </div></div>';                                           
                                             $content .= '<div class="form-group">
                                             
                                            <label class="col-sm-3 control-label">Transaction Date <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
...
{       
	...
	$level1 = @mysql_query("select id, account_no, name from accounts where account_no between ".$prefix."01 and ".$prefix."99 and id NOT in (select account_id from bank_account)");
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER BANK ACCOUNT</h4>
		...
		$content .='<form method="post" class="panel form-horizontal form-bordered">
  			  		...
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER CASH ACCOUNT</h4>
	...
	$content .= '<div class="form-group">
                                            ...
                                            <label class="col-sm-3 control-label">Select Account(From Chart of Accounts) <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                          <select id="acct_id" name="acct_id" class="form-control"><option value="">'.$fixed_acc.'</select>
                                            </div></div>';
                                  if ($prefix == '1212')
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Name of Bank <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="text" name="bank_name" id="bank_name" class="form-control">
                                            </div></div>
                                            <div class="form-group">
                                            <label class="col-sm-3 control-label">Bank Account No <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" id="bank_acct_no" name="bank_acct_no"   class="form-control">
                                            </div></div>';
                                             
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Minimum Balance <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="text" id="min_bal" name="min_bal" class="form-control">
                                            </div></div>';
                                   if ($prefix == '1212')
                                   
                                             $content .= "<div class='panel-footer'><button type='reset' class='btn btn-default' onclick=\"xajax_addBankAcctForm('".$prefix."')\">Reset</button>
                                            <button type='button' class='btn btn-primary' onclick=\"xajax_addBankAcct(getElementById('acct_id').value, getElementById('bank_name').value, getElementById('bank_acct_no').value, getElementById('min_bal').value, '1212'); return false;\">Save</button>";
			
			            else    
			                      $content .= "<div class='panel-footer'><button type='reset' class='btn btn-default' onclick=\"xajax_addBankAcctForm('".$prefix."')\">Reset</button>
                                            <button type='button' class='btn btn-primary' onclick=\"xajax_addBankAcct(getElementById('acct_id').value, '', '', getElementById('min_bal').value, '1211'); return false;\">Save</button>";	
	 $content .= '</div></form></div>';
...
function addBankAcct($acc_id, $bank_name, $bank_acct_no, $min_bal, $prefix)
{
	$resp = new xajaxResponse();
	$calc = new Date_Calc();
	if ($prefix == '1212' && ($acc_id == '' || $bank_name == '' || $bank_acct_no == '' || $min_bal == ''))
	{
...
function listBankAccts($prefix)
{
	...
	$date = $date." 23:59:59";
	$res = @mysql_query("select ac.id as acc_id, ac.name as acc_name, ba.id as bank_id, ba.account_id, ba.account_balance, ba.min_balance, ba.bank_account_no, ba.bank from accounts ac, bank_account ba where ba.account_id = ac.id and ac.account_no like '".$prefix."%'");
	...
	{ 
		if ($prefix == '1212')
			...
			$content = '<div class="panel panel-default" id="demo">
                            <div class="panel-heading">
                                <h3 class="panel-title">LIST OF BANK ACCOUNTS</h3>                                
                            </div>';
		elseif ($prefix == '1211')
		$content = '<div class="panel panel-default" id="demo">
                            <div class="panel-heading">
		...
		while ($fxrow = @mysql_fetch_array($res))
		{
			...
			mysql_query("update bank_account set account_balance='".$sub2_total."' where id='".$bank1['id']."'");

			//$color = ($i%2 == 0) ? "lightgrey" : "white";
			$content .= "
				    <tr>
				        <td>".$fxrow['bank']."</td><td>".$fxrow['acc_name']."</td><td>".$fxrow['bank_account_no']."</td><td>".number_format($fxrow['min_balance'], 2)."</td><td>".number_format($sub2_total, 2)."</td><td><a href='javascript:;' onclick=\"xajax_editBankAcctForm('".$fxrow['bank_id']."', $prefix); return false;\">Edit</a>&nbsp;<a href='javascript:;' onclick=\"xajax_deleteBankAcct2('".$fxrow['bank_id']."', '".$prefix."'); return false;\">Delete</a></td>
				    </tr>
				    ";		
		}
		$content .= "</tbody></table></div>";
...
{       $modes="";
	...
	$content ="";
	$content .="<form method='post' class='panel form-horizontal form-bordered' enctype='multipart/form-data' action='transactionAccounts/importBulkPost'>";
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">POST A SCHEDULE</h4>
                                               		 <div class="alert alert-warning">The excel file should have the columns: MemberNo, ReceiptNo, Shares, then the Account Codes  of the transactions <br>The file should have the etension .xls</div>
													 <div><font color="#F00">*</font> - Required.</div>
                                           	 </div>
                                        </div>';
                                                                                                           
         				$content .='<div class="form-group">
					    <label class="col-sm-3 control-label">Organization <font color="#F00">*</font>:</label>
					    <div class="col-sm-6"><span><select class="form-control" name="company" id="company" onchange="xajax_loadBranches(this.value);" required>
					     ...
					     $content .='<div class="form-group">
					    <label class="col-sm-3 control-label">Branch <font color="#F00">*</font>:</label>
					    ...
					    <div id="branchDiv">
                                            ...
                                            <label class="col-sm-3 control-label">Select Dest Bank Account <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                           <select name="bank_acct" class="form-control" id="bank_acct" required>'.$accts.'</select>
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Contact Person <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" class="form-control" name="contact" id="contact">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">File Ref <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="rcpt_no" id="rcpt_no"  class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Cheque No (Optional) <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="cheque_no" id="cheque_no" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Date <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                           <span><input type="text" class="form-control" name="date" id="date" placeholder="'.date('Y-m-d').'"></span>
                                            ...
                                            $resp->call("createDate","date");
                                              ...
                                              $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">File <font color="#F00">*</font>:</label>
                                            <div class="col-sm-6">
                                            <div class="input-group">
                                                 <span class="input-group-btn">
                                                    <div class="btn btn-primary">
                                                        <span class="icon iconmoon-file-3"></span><input type="file" name="fname" id="fname" required>
                                                    </div>
                                                </span>
                                            </div>
                                        </div></div>'; 
...
function list_bulk($file_ref, $from_date,$to_date){
	...
	$content = '<div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="panel panel-default" action="">
                            <div class="panel-heading">
                                <p><h5 class="semibold text-primary mt0 mb5">SEARCH FOR BULK POSTING</h5></p>
                            </div>               
                            <div class="panel-body">';
