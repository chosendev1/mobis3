...
function sharesRegForm($memid = 0, $action = 'cash',$num_shares='')
{
...
$content .= '<div class="panel-body pt0 pb0">
	...
	$content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Buying Member <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                            <select name="memid" id="memid" class="form-control">'.$members.'</select>
                                            </div>
                                            </div>';
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">No. of Shares <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type=text name="num_shares" class="form-control" id="num_shares" value="'.$num_shares.'" onblur=\'xajax_getShareVal(document.getElementById("num_shares").value, document.getElementById("memid").value); return false;\'><div id="share_div"></div>
                                            </div></div>';
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Select Payment Mode <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <select name="mode" id="mode" class="form-control" onchange=\'xajax_sharesRegForm(getElementById("memid").value, getElementById("mode").value,getElementById("num_shares").value); return false;\'>'.$modes.'</select>
                                            </div></div>';
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Select Paying Member <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <select name="mem_acc_id" class="form-control" id="mem_acc_id" class="form-control">'.$mems.'</select>
                                            </div></div>';
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Dest. Bank Acc <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <select name="bank_act" class="form-control" id="bank_act" class="form-control">'.$accts.'</select>
                                            </div></div>';
                                            $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Voucher No <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="rcpt_no" class="form-control" id="rcpt_no" onblur=\'xajax_val_receipt(getElementById("rcpt_no").value, "0")\'>
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Date of Purchase <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="text" class="form-control" id="date" name="date" value="'.date('Y-m-d').'" />
                                            ...
                                            <button type='button' class='btn btn-primary' onclick=\"xajax_regShares(document.getElementById('memid').value, document.getElementById('num_shares').value, document.getElementById('rcpt_no').value, document.getElementById('bank_act').value, getElementById('mem_acc_id').value, getElementById('date').value); return false;\">Save</button>";
                                            $content .= '</div>';
			...
			if ($mem_percentage < $row['max_percent'])
			{
				...
				if ($result)
				{
					...
					*/
					...
					$content = "<font color=red>You cannot purchase over ".$row['max_percent']."% of available shares.</font>";
		}else{
...
$content .= '<div class="panel-body pt0 pb0">
	...
	$content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Selling Member <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           ...
                                           <input type=text name="num_shares" id="num_shares" class="form-control" onblur=\'xajax_getShareVal(document.getElementById("num_shares").value, document.getElementById("smemid").value); return false;\'>
                                             ...
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Date of Transfer <font color="#FF0000">*</font>:</label>
                                            <div class="col-sm-6">
                                           <input type="text" class="form-control" id="date" name="date" value="'.date('Y-m-d').'" />
                                            </div></div>';
...
function transferShares($smem_id, $bmem_id, $num_share, $date)
{       $content ="";
	 list($year,$month,$mday) = explode('-', $date);
	$resp = new xajaxResponse();
	if(isFYClosed(parseFY($year,$month,$mday))){
