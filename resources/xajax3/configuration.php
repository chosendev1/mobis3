...
$response="<font color='green'>Successfull</font>";
else
$response="<font color='red'>Failed</font>";
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER A NEW BRANCH</h4>
	                                    ...
	                                    $content .= '<div class="form-group">
                                           ...
                                           <input type="text" id="branch_name" name="branch_name" class="form-control">
                                            ...
                                            <div class="col-sm-6">
                                           <input type="text" id="email" name="email" placeholder="e.g anyname@domain.com" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                           ...
                                           <input type="text" name="prefix" id="prefix" class="form-control">
                                            ...
                                            $content .= "<div class='panel-footer'><button type='reset' class='btn btn-default' onclick=\"xajax_addBranchForm(); return false;\">Reset</button>
                                            <button type='button' class='btn btn-primary'   onclick=\"xajax_insertBranch(getElementById('sacco_name').value, getElementById('branch_no').value, getElementById('branch_name').value, getElementById('email').value, getElementById('address').value, getElementById('share_value').value, getElementById('report_period').value, getElementById('min_shares').value, getElementById('max_share_per').value, getElementById('loan_share_per').value, getElementById('loan_save_per').value, getElementById('guarantor_share_per').value, getElementById('guarantor_save_per').value, getElementById('prefix').value); return false;\">Save</button>";
...
elseif(mysql_num_rows(mysql_query("select prefix from branch where prefix='".$prefix."'"))>0)
	...
	$content = "<font color='green'>Branch Sucessfully Registered.</font>";
	
else{
	$content ="<font color='red'>Failed to register Branch.</font>";
$response->alert("Failed to register Branch. Please contact Mobis. ".mysql_error());
}
...
function showProvisions()
{
	...
	if (@mysql_num_rows($prov_res) > 0)
	{
 		...
 		$content .= '<table class="table table-striped table-bordered" id="table-tools">
				...
				<thead><th></th><th>Range</th><th>Percentage Loss</th><th>Action</th>
			    </thead><tbody>';
	...
	$content ='<div class="row">
        ...
        $content .='<div class="form-group">
			 ...
			 $content.='<div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        <label class="control-label">Percentage Loss:</label>
  			  		...
  			  		<div class="form-group header bgcolor-default">
	                                   ...
	                                   /* $content .= '<div class="form-group">
                                           ...
                                           <input type="text" id="branch_name" name="branch_name" class="form-control">
                                             ...
                                             $content .= '<div class="form-group">
                                              <input type=hidden id="branch_name" name="branch_name" value="'.$row[branch_name].'">
                                            <label class="col-sm-3 control-label">Email:</label>
                                            <div class="col-sm-6">
                                           ...
                                           <input type="text" id="min_shares" name="min_shares" value="'.$row['min_shares'].'" class="form-control">
                                             ...
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Maximum Share Percentage:</label>
                                            <div class="col-sm-6">
