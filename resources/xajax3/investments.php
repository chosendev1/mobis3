...
{       
	...
	$former=mysql_fetch_array(mysql_query("select id, account_no, name from accounts where account_no='".$prefix."'"));
	$level1 = mysql_query("select id, account_no, name from accounts where account_no like '".$prefix."%' and account_no >= ".$prefix."1 and account_no <= ".$prefix."9 and account_no<>'1252'");
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER INVESTMENT</h4>
	...
	while($row = mysql_fetch_array($sth)){
		$type .= "<option value='".$row['account_no']."'>".$row['account_no']." - ".strtoupper($row['name']);
	                                    ...
	                                    $content .= '<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <select id="ptype" name="ptype" onchange=\'xajax_addInvestmentForm(getElementById("ptype").value); return false;\' class="form-control"><option value="'.$prefix.'">'.$prefix.' - '.$former['name'].$type.'</select>
                                            </div></div>';
                                            $content .= '<div class="form-group">
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">SELL INVESTMENT</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                                        </div>';
	/* $sth = mysql_query("select account_no, name from accounts where account_no >='113' and account_no <= '119'");
	 ...
	 $content .= '<div class="form-group">
                                          ...
                                          <select id="acc_id" name="acc_id" class="form-control">'.$fixed_acc.'</select>
                                           ...
                                           <select name="bank_acct_id" id="bank_acct_id" class="form-control">'.$accts.'</select>
                                            ...
                                            <label class="col-sm-3 control-label">Unit Purchase Price:</label>
                                            <div class="col-sm-6">
                                          <input type="numeric" name="purchase_price" id="purchase_price" class="form-control">
                                            </div></div>';
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="panel panel-default" action="">
                            <div class="panel-heading">
                                <p><h5 class="semibold text-primary mt0 mb5">LIST OF INVESTMENTS</h5></p>
                            </div>               
...
function deleteInvestment2($pid, $contact, $from_date,$to_date, $branch_id)
{
	$resp = new xajaxResponse();
	/*if($_SESSION['position'] <>'Manager'){
		$resp->alert("Access Denied! \nOnly the Manager can edit account");
		return $resp;
	}*/
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="panel-title">SELL INVESTMENT</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                                        </div>';
