...
function getShareVal($num_shares, $mem_id)
{
	...
	$content = "<font color=red>Total Value of shares to be purchased is:".$totalval."</font>";
...
// Direct purchases, in-ward transfers and out-ward transfers
	...
	elseif($type == 'group_id'){
		...
		$content .= '<div class="panel panel-default" id="demo">
                            <div class="panel-heading">
                                <p><h5 class="semibold text-primary mt0 mb5">SHARES LEDGER FOR THE GROUP: '.libinc::getItemById("loan_group",$mem_id,"id","name").'</h5></p>                                
                            </div>';
