...
function editCustForm($id, $type, $mem_no, $mem_name, $start,$branch_id,$photo_name)
{
	...
	$mem = @mysql_fetch_array(@@mysql_query("select mem_no, first_name, last_name, telno, email, address, sex, kin, kin_telno, date_format(dob, '%Y') as year, date_format(dob, '%m') as month, date_format(dob, '%d') as mday,photo_name,amount, loan from member where id='".$id."'"));
...
//$sql = 'select SUM(d.amount) as total,* from loan_applic l LEFT JOIN deposit d ON l.mem_no = d.memeaccount_id';
...
<div id="main_container" class="main_container container_16 clearfix">
                ...
                <div class="box grid_16">
						<h2 class="box_head">Customer Data For '
                    ...
                    <div class="grid_16 box clearfix">
						<div class="indented_button_bar clearfix">
							...
							<a class="blue btn" href="'.base_url().'loans/apply/'.$id.'">
							
							New Loan
							
								
							</a>
							<a class="red btn" href="'.base_url().'savings/registerDeposit/'.$mem['mem_no'].'">
		...
		<br>
		<span class="name sort_1">Total Loans:'.$mem['loan'].'</span>
		<br>
		<span class="name sort_1">Savings:'.$mem['amount'].'</span>
		<br>
		<span class="name sort_1">Email:'.$mem['email'].'</span><br>
								...
								<span><a href="'.base_url().'/customers/listOfNonMembers/'.$mem['mem_no'].'"><i class="icon ico-pencil"></i>Edit Photo</a></span>
							</span>		
