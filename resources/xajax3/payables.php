...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">REGISTER PAYABLE</h4>
	                                    ...
	                                    $content .= '<div class="form-group">
                                          ...
                                          <select id="acc_id" name="acc_id" class="form-control">'.$fixed_acc.'</select>
                                            ...
                                            <div class="col-sm-6">
                                           <input type="numeric" id="initval" name="initval"  class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
...
{   
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="panel panel-default" action="">
                            <div class="panel-heading">
                                <p><h5 class="semibold text-primary mt0 mb5">SEARCH FOR '.strtoupper($type).' PAYABLES</h5></p>
                            </div>               
	...
	{
		$res = @mysql_query("select ac.account_no, p.date, ac.id as acc_id, ac.name as acc_name, p.id as pid, p.amount as amount, p.maturity_date as mdate, p.vendor as creditor, p.status as status, p.rate as rate from accounts ac join payable p on p.account_id = ac.id where p.date >='".$from_date."' and p.date <= '".$to_date."' and p.vendor like '%".$contact."%' ".$where_account." ".$branch." order by p.vendor,p.maturity_date desc");
	}
...
$content .= '<div class="panel-body pt0 pb0">
					 ...
					 $content .= '<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                           <input type="numeric" id="amt_paid" name="amt_paid"  class="form-control">
                                            </div></div>';
