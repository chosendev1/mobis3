...
$content .= '<div class="panel-body pt0 pb0">
	...
	$content .= '<div class="form-group">
                                            ...
                                            $content .='<div class="form-group">
                                            <label class="col-sm-3 control-label">Product Name(From Chart of Accounts):</label>
                                            <div class="col-sm-6">
	...
	$content .= '</select>
                                           ...
                                           <input type="int" name="min_bal" id="min_bal" class="form-control">
                                             ...
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Maturity Period (Months before Loan):</label>
                                            <div class="col-sm-6">
                                           <input type="int" name="grace_period" id="grace_period" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Interest Frequency:</label>
                                            <div class="col-sm-6">
                                           ...
                                           <input type="numeric" name="int_rate" id="int_rate" class="form-control">
                                             ...
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Tax % on Interest:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="tax_rate" id="tax_rate" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Charge % on Withdrawal:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="withdrawal_perc" id="withdrawal_perc" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Flat Charge on Withdrawal:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="withdrawal_flat" id="withdrawal_flat" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Charge % on Deposit:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="deposit_perc" id="deposit_perc" class="form-control">
                                            </div></div>';
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Flat Charge on Deposit:</label>
                                            <div class="col-sm-6">
                                           <input type="numeric" name="deposit_flat" id="deposit_flat" class="form-control">
                                            </div></div>';                                            
                                             $content .= '<div class="form-group">
                                            <label class="col-sm-3 control-label">Monthly Charge:</label>
                                            <div class="col-sm-6">
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	<h4 class="semibold text-primary mt0 mb5">EDIT A SAVINGS PRODUCT</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                                        </div><div id="responsediv" class="alert alert-dismissable alert-danger"></div>';
