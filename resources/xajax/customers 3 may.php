                                    ...
                                    <div class="row">  
                                     <div class="span6">
                                        ...
                                        <div class="span6">
                                            ...
                                            <div class="row">
                                                <div class="span6"><input type="text" class="form-control" id="from_date" name="from_date" placeholder="From" /></div>
                                                <div class="span6"><input type="text" class="form-control" id="to_date" name="to_date" placeholder="to" /></div>
                                            </div>      
                                        </div>
                                    </div>
                                </div> '; 
...
$content .= '<div class="panel-body pt0 pb0">
	 ...
	 <div class="middle">
                ...
                <div class="informer">
                    <a href="dashboard/" btn btn-success><i class="icon ico-home "></i>
				...
				<div class="informer">
                    <a href=" '.base_url().'/customers/listOfNonMembers/'.$mem['mem_no'].'" btn btn-success><i class="icon ico-pencil "></i>
                        <span class="icomg-pencil"></span>
                        <span class="text">Edit Photo</span></a>
                    </a>
                </div>
				
				
				<div class="informer">
                    <a href=" '.base_url().'/customers/listOfNonMembers/'.$id.'?view=customer" btn btn-success><i class="icon ico-pencil "></i>
                        <span class="icomg-pencil"></span>
                        <span class="text">Edit Customer</span></a>
                    </a>
                </div>
	 ...
	 <a class=" btn" href="'.base_url().'savings/registerDeposit/'.$mem['mem_no'].'">
                        <span class="icomg-comments3"></span>
                        <span class="text">Add New Savings</span>
                    </a>
                </div>                
                
                <div class="informer">
                    <a href="'.base_url().'loans/apply/'.$id.'">
                        <span class="title">$</span>
                        <span class="text">Add New Loan</span>
                    </a>
                </div>                
...
$content .= '
	...
	<div class="row-form">
                           ...
                           <label class="control-label">Email:</label>
                                           ...
                                           <input type="text" id="email" name="email" class="form-control" placeholder="e.g example@domain.com">
                                            </div></div>';
                                             $content .= ' <div class="row-form">
							    <div class="span5">
                           ...
                           <label class="control-label">Gender:</label>
                                           ...
                                           <select type=text name="sex" id="sex" class="form-control" required><option value=""><option value="M">M<option value="F">F<option value="G">Others</select>
                                            </div></div>';
                                             $content .= ' <div class="row-form">
							    <div class="span5">
...
function membersList($type, $mem_no, $mem_name, $start,$branch_id)
{
	...
	{				    	    
		...
		<table class="table borderless">';
 		$content .= '<td>#</td><th>Name</th><td>Member No.</td><th>Sex</th><th>Email</th><th>Phone NO.</th><th>Address</th><th>Next Of Kin</th><th>Kin phone.</th><th>Photo</th><th>Action</th><tbody>';
			...
			$content .= "
				    <tr>
				      <td>".$i."</td>
				       ...
				       <td><a href='javascript:;' onclick=\"xajax_editCustForm('".$members['id']."', '".$type."', '".$mem_no."', '".$mem_name."', '".$start."','".$branch_id."'); return false;\">$members[first_name] $members[last_name]</td></td>
				       ...
				       <td><a href='javascript:;' onclick=\"xajax_editCustForm('".$members['id']."', '".$type."', '".$mem_no."', '".$mem_name."', '".$start."','".$branch_id."'); return false;\">$members[kin_telno]</td>
						<td><img src='photos/$members[photo_name]' width=40 height=20></td>
						  <td><a href='javascript:;' onclick=\"xajax_editCustForm('".$members['id']."', '".$type."', '".$mem_no."', '".$mem_name."', '".$start."','".$branch_id."'); return false;\"><span class='icon-pencil'></span>Edit</td>
				       ";
...
function editCustForm($id, $type, $mem_no, $mem_name, $start,$branch_id)
{
	...
	$mem_d = @mysql_fetch_array(@@mysql_query("select sum(amount) as amount from deposit where cheque_no='".$id."'"));
	$mem_l = @mysql_fetch_array(@@mysql_query("select count(mem_id) as mem_id from loan_applic where mem_id='".$id."'"));
	...
	<div class="block-fluid">
	 ...
	 <a class=" btn" href="'.base_url().'savings/registerDeposit/'.$mem['mem_no'].'">
				...
				<div class="block-fluid" align="right" style="font-size:15px;">
				 <div class="informer">
						...
						<img src="photos/'.$mem['photo_name'].'?dummy='.time().'" width=200 height=170><br>
		<span class="name sort_1">'.$mem['first_name'].'</span><br>
		<span class="name sort_1">Savings:'.$mem_d['amount'].'</span><br>
		<span class="name sort_1">Pending Loans:'.$mem_l['mem_id'].'</span><br>
		
		<span class="name sort_1">'.$mem['email'].'</span><br>
...
$content .= '<div class="panel-body pt0 pb0">
  			  		<div class="form-group header bgcolor-default">
                                 		<div class="col-md-12">
                                                	...
                                                	<h4 class="semibold text-primary mt0 mb5">EDIT CUSTOMER DETAILS FOR '.$mem['first_name'].'</h4>
                                               		 <p class="text-default nm"></p>
                                           	 </div>
                ...
                <div class="row-form">
                    <div class="span5">
					<span class="top">
					First Name</span><input type="text" name="first_name" id="first_name" value="'.$mem['first_name'].'" required/></div>
                    <div class="span5"><span class="top">Last Name</span><input type="text" name="last_name" id="last_name" value="'.$mem['last_name'].'" required/></div>                    
                </div>
				...
				<div class="row-form">
                    <div class="span5">
					<span class="top">
					Member No:</span><input type="text" name="mem_no" id="mem_no" value="'.$mem['mem_no'].'" required/></div>
                    <div class="span5"><span class="top">Date Of Birth:</span><input type="text" name="dob" id="dob" class="form-control" value="'.$mem['year'].'-'.$mem['month'].'-'.$mem['mday'].'"></div>                    
                </div>
                    ...
                    <div class="span5">
					<span class="top">
					Phone:</span><input type="text" name="phone" id="phone"  value="'.$mem['telno'].'" required/></div>
                    <div class="span5"><span class="top">
					Email:</span><input type="email" id="email" name="email" value="'.$mem['email'].'" required/></div>                    
                </div>
                    ...
                    <div class="span5">
					<span class="top">
				Physical Address:</span><input type="text" name="paddress" id="paddress" value="'.$mem['address'].'" required/></div>
                    <div class="span5"><span class="top">
					Next of Kin Name:</span><input type="text" name="kin_name" id="kin_name" value="'.$mem['kin'].'" required/></div>                    
                </div>
                    ...
                    <div class="span5">
					<span class="top">
				Next of Kin Phone No:</span><input type="text" name="kin_phone" id="kin_phone" value="'.$mem['kin_telno'].'" required/></div>
