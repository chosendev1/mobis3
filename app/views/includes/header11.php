...
function timerIncrement() {
    idleTime = idleTime + 1;
    if (idleTime > idleMax) { 
        window.location="serviceAuth/logout/";
    }
}
</script>';
        ...
        <header id="header" class="navbar navbar-fixed-top">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0);">
                   ...
                   <span><img src="resources/themes/admire/image/logo/logo.png" width="180"><span>
                </a>
                <!--/ Brand -->
            </div>
            <!--/ END navbar header -->
                        ...
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="meta">
                                <!-- <span class="avatar"><img src="resources/themes/admire/image/avatar/avatar7.jpg" class="img-circle" alt="" /></span> -->
                                 <span class="text hidden-xs hidden-sm pl5"><?=CAP_Session::get('username')?></span> 
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <!-- <li class="pa15">
                                ...
                                <h5 class="semibold hidden-md hidden-lg">
                                    <p class="nm"><?=CAP_Session::get('username')?></p>
                            ...
                            <li class="divider"></li>
                            <li><a href="user/profile#account"><span class="icon"><i class="ico-user-plus2"></i></span> My Accounts</a></li>
                            <li><a href="user/profile"><span class="icon"><i class="ico-cog4"></i></span> Profile Setting</a></li>
                            <li><a href="help" target="blank_"><span class="icon"><i class="ico-question"></i></span> Help</a></li>
                            <li class="divider"></li> -->
                           <li><a href="user/editAccount/<?=CAP_Session::get('userId')?>"><span class="icon"><i class="ico-pencil"></i></span> Edit Account</a></li>
                            <li><a href="serviceAuth/logout"><span class="icon"><i class="ico-exit"></i></span> Sign Out</a></li>
                        </ul>
                    </li>
                    <!-- Profile dropdown -->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="javascript:;" onclick="xajax_dummyCall();">Copy</a></li>
                                <li><a href="javascript:;" onclick="xajax_dummyCall();">PDF</a></li>
                                <li><a href="javascript:;" onclick="xajax_dummyCall();">CSV</a></li>
                                <li class="divider"></li>
                                <li><a href="javascript:;" onclick="xajax_dummyCall();">Print</a></li>
                                <li class="divider"></li>
                                <li><a href="javascript:;" onclick="xajax_testXajax();">Exit</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="games/eggs">
                                <span class="meta">
                                    <span class="text">Eggs Game</span>
                                </span>
                            </a>
                        </li>
                    </ul>
