                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="profile">
                                ...
                                <?php
								error_reporting(0);
                                	$form = new forms(true,true,"POST","staff/regStaff","staffprofile-form","controller","",true);
                                	$form->setHeadings("Staff Profile", "");
                                	$form->addField(array("lableName" => "Photo <font color='#f00'>*</font>:", "type" => "file", "name" => "photo", "desc" => ""));
                                	$form->addField(array("lableName" => "First Name <font color='#f00'>*</font>:", "type" => "text", "name" => "firstName", "value" => $emp->firstName, "desc" => "", "required" => "yes"));
                                	$form->addField(array("lableName" => "Middle Name", "type" => "text", "name" => "middleName","value" => $emp->middleName, "desc" => ""));
                                	$form->addField(array("lableName" => "Last Name <font color='#f00'>*</font>:", "type" => "text", "name" => "lastName","value" => $emp->lastName, "desc" => "", "required" => "yes"));
                                	$form->addField(array("lableName" => "Date of Birth <font color='#f00'>*</font>:", "type" => "date", "name" => "dob","value" => $emp->dob, "desc" => "", "required" => "yes"));
                                	$form->addField(array("lableName" => "Gender <font color='#f00'>*</font>:", "type" => "radio", "name" => "gender","value" => $emp->gender, "desc" => "", "options" => array("M" => "Male", "F" =>"Female")));
                                	$form->addField(array("lableName" => "Submit", "type" => "button", "name" => "save", "desc" => "Stupid Button"));
                                	$form->addField(array("lableName" => "phone <font color='#f00'>*</font>:", "type" => "text", "name" => "phone","value" => $emp->phone, "desc" => "", "required" => "yes"));
                                	$form->addField(array("lableName" => "email <font color='#f00'>*</font>:", "type" => "text", "name" => "email","value" => $emp->email, "desc" => ""));
                                	$form->addField(array("lableName" => "Role <font color='#f00'>*</font>:", "type" => "select", "name" => "role","value" => $emp->roleId, "desc" => "", "options" => libinc::getRoles(), "nested" => false, "required" => "yes"));
                                	//$form->addField(array("type" => "heading", "heading" => "Location"));
                                	$form->addField(array("lableName" => "Nationality <font color='#f00'>*</font>:", "type" => "select", "name" => "country","value" => $emp->country, "desc" => "", "options" => libinc::getCountry(""), "nested" => false, "required" => "yes"));
                                	$form->addField(array("lableName" => "Identity Type <font color='#f00'>*</font>:", "type" => "select", "name" => "identityType","value" => $emp->identityType, "desc" => "", "options" => array("Passport" => "Passport", "Employee" => "Employee", "Student" => "Student", "National Id" => "National Id", "Medical Card" => "Medical Card", "Other" => "Other"), "nested" => false));
                                	$form->addField(array("lableName" => "Identity Number <font color='#f00'>*</font>:", "type" => "text", "name" => "identityNumber","value" => $emp->identityNumber, "desc" => ""));
