...
<div class="row">
                <div class="col-md-6 col-lg-8">
                    ...
                    <ul class="nav nav-tabs panel panel-default panel-block">
                        ...
                        <li><a href="#user-settings" data-toggle="tab">STRUCTURE</a></li>
                    </ul>
                        ...
                        <div style="" class="tab-pane active" id="user-overview">
                            <!--div class="list-group"-->
                                <div class="list-group-item">
                                    ...
                                    <p>
                                        <label class="col-lg-4 control-label">Organisation Name: </label><button class="btn btn-lg btn-primary">CRANEAPPS COLLEGE</button>
                                    </p>
                                    <p>
                                        <label class="col-lg-4 control-label">PARENT: </label><button  class="btn btn-lg btn-primary">FACULTY</button>
                                    </p>
                                </div>
                                <!--/div-->
   ...
   =========================-->                     
                        <div class="tab-pane scrollable list-group" id="user-settings">
                            ...
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title"><?=$this->lang['organizationStructure']?></h4>

                                        <div class="form-group">
                                            <label><?=$this->lang['structure']?> <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Name" data-parsley-required="true">
                                        </div>
                                        <div class="form-group">
                                            <label><?=$this->lang['parentId']?><span class="text-danger">*</span></label><select class="form-control select2 placeholder populate"></select>
                                </div>
                                        <!--div class="form-group">
                                            <label>Postal Address <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Enter Postal Address" data-parsley-type="phone" data-parsley-required="true">
                                        </div>
                                        <div class="form-group">
