...
<div class="row">
                <div class="col-md-6 col-lg-8">
                    ...
                    <ul class="nav nav-tabs panel panel-default panel-block">
                        ...
                        <li><a href="#user-settings" data-toggle="tab">HOUSES/HALLS</a></li>
                    </ul>
                        ...
                        <div style="" class="tab-pane active" id="user-overview">
                            <!--div class="list-group"-->
                                <div class="list-group-item">
                                    ...
                                    <p>
                                        <label class="col-lg-4 control-label">ORGANIZATION : </label><button class="btn btn-lg btn-primary">CRANEAPPS COLLEGE</button>
                                    </p>
                                    <p>
                                        <label class="col-lg-4 control-label">HOUSE/HALL NAME : </label><button  class="btn btn-lg btn-primary">GEORGE</button>
                                    </p>
                                </div>
                                <!--/div-->
   ...
   =========================-->                     
                        <div class="tab-pane scrollable list-group" id="user-settings">
                            ...
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title"><?=$this->lang['house/hall']?></h4>

                                        <div class="form-group">
                                            <label><?=$this->lang['hallName']?><span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Hall Name" data-parsley-required="true">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label><?=$this->lang['unitName']?><span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Enter unit name" data-parsley-type="text" data-parsley-required="true">
                                        </div>
                                        <!--END-->
                                    </div>
                                   </div>
