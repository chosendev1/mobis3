...
<html class="backend">
	...
	<base href="<?=base_url()?>">
        ...
        <link rel="stylesheet" href="resources/themes/admire/plugins/datatables/css/jquery.datatables.min.css">
        <!--/ Plugins stylesheet -->
    ...
    <body>
            ...
            <div class="navbar-toolbar clearfix">
                        ...
                        <script class="mustache-template" type="x-tmpl-mustache">
                            ...
                            <a href="page-message-rich.html" class="media border-dotted new">
                                <span class="pull-left">
                                    <img src="resources/themes/admire/image/avatar/{{picture}}" class="media-object img-circle" alt="">
                                </span>
                            ...
                            <div class="dropdown-body slimscroll">
                                ...
                                <div class="media-list">
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar1.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                                    ...
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar3.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                                    ...
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar4.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                                    ...
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar5.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                                    ...
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar8.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                                    ...
                                    <a href="page-message-rich.html" class="media border-dotted read">
                                        <span class="pull-left">
                                            <img src="resources/themes/admire/image/avatar/avatar9.jpg" class="media-object img-circle" alt="">
                                        </span>
                                        <span class="media-body">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="meta">
                                <span class="avatar"><img src="resources/themes/admire/image/avatar/avatar7.jpg" class="img-circle" alt="" /></span>
        ...
        <aside class="sidebar sidebar-left sidebar-menu">
            ...
            <section class="content slimscroll">
                ...
                <ul class="topmenu topmenu-responsive" data-toggle="menu">
                    <li >
                        <a href="resources/themes/admire/gh_frontend">
        ...
        <aside class="sidebar sidebar-right">
            ...
            <div class="offcanvas-container" data-toggle="offcanvas" data-options='{"openerClass":"offcanvas-opener", "closerClass":"offcanvas-closer"}'>
                ...
                <div class="offcanvas-wrapper">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="media">
                            ...
                            <!--/ indicator -->
                            <img data-toggle="unveil" src="resources/themes/admire/image/background/400x250/placeholder.jpg" data-src="resources/themes/admire/image/background/400x250/background3.jpg" alt="Cover" width="100%">
                        </div>
                        <!--/ media -->
                    </div>
                    <!--/ thumbnail -->
                ...
                <div class="panel-body text-center" style="margin-top:-55px;z-index:11">
                    <img class="img-circle mb5" src="resources/themes/admire/image/avatar/avatar7.jpg" alt="" width="75">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar1.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar2.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar.png" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar3.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar4.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar5.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar6.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar8.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        <span class="media-object pull-left">
                            <img src="resources/themes/admire/image/avatar/avatar9.jpg" class="img-circle" alt="">
                        </span>
                        <span class="media-body">
                        ...
                        <div class="content slimscroll">
                            ...
                            <li class="media media-right">
                                <a href="javascript:void(0);" class="media-object">
                                    <img src="resources/themes/admire/image/avatar/avatar7.jpg" class="img-circle" alt="">
                                </a>
        ...
        <script type="text/javascript" src="resources/themes/admire/plugins/datatables/js/jquery.datatables.min.js"></script>
        
        <script type="text/javascript" src="resources/themes/admire/plugins/datatables/tabletools/js/tabletools.min.js"></script>
        
        <script type="text/javascript" src="resources/themes/admire/plugins/datatables/tabletools/js/zeroclipboard.js"></script>
        
        <script type="text/javascript" src="resources/themes/admire/plugins/datatables/js/jquery.datatables-custom.min.js"></script>
        
        <script type="text/javascript" src="resources/themes/admire/javascript/tables/datatable.js"></script>
