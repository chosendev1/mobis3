                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <ul class="list-group list-group-tabs">
                            ...
                            <li class="list-group-item"><a href="#employement" data-toggle="tab"><i class="ico-user2 mr5"></i> Employment</a></li>
                             <li class="list-group-item"><a href="#qualifications" data-toggle="tab"><i class="ico-user2 mr5"></i> Qualifications</a></li>
                              <li class="list-group-item"><a href="#skills" data-toggle="tab"><i class="ico-user2 mr5"></i> Skills & Experience</a></li>
                        ...
                        <ul class="list-table">
                            ...
                            <li class="text-left">
                                <h5 class="semibold ellipsis mt0">Profile</h5>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="profile">
                                ...
                                <?php
                                	$form = new forms(true,true,"POST","user/staffProfile","profile-form","controller","",true);
                                	$form->setHeadings("Profile", "This information appears on your public profile, search results, and beyond.");
                                	$form->addField(array("lableName" => "Photo", "type" => "image", "name" => "photo", "desc" => "Upload your photo"));
                                	$form->addField(array("lableName" => "First Name", "type" => "text", "name" => "firstName", "value" => $emp->firstName, "desc" => "Enter your first Name"));
                                	$form->addField(array("lableName" => "Middle Name", "type" => "text", "name" => "middleName","value" => $emp->middleName, "desc" => "Enter your middle Name"));
                                	$form->addField(array("lableName" => "Last Name", "type" => "text", "name" => "lastName","value" => $emp->lastName, "desc" => "Enter your last Name"));
                                	$form->addField(array("lableName" => "Date of Birth", "type" => "date", "name" => "dob","value" => $emp->dob, "desc" => "Select Date Of Birth"));
                                	$form->addField(array("lableName" => "Gender", "type" => "radio", "name" => "gender","value" => $emp->gender, "desc" => "", "options" => array("M" => "Male", "F" =>"Female")));
                                	$form->addField(array("lableName" => "Submit", "type" => "button", "name" => "save", "desc" => "Stupid Button"));
                                	$form->addField(array("lableName" => "phone", "type" => "text", "name" => "phone","value" => $emp->phone, "desc" => "e.g 787836784"));
                                	$form->addField(array("lableName" => "email", "type" => "text", "name" => "email","value" => $emp->email, "desc" => "e.g myname@hostname.com"));
                                	$form->addField(array("type" => "heading", "heading" => "Location"));
                                	$form->addField(array("lableName" => "Nationality", "type" => "select", "name" => "country","value" => $emp->country, "desc" => "", "options" => libinc::getCountry(""), "nested" => false));
                                	$form->addField(array("lableName" => "Identity Type", "type" => "select", "name" => "identityType","value" => $emp->identityType, "desc" => "", "options" => array("Identity" => "Identity", "Passport" => "Passport", "Lessez-passer" => "Lessez-passer"), "nested" => false));
                                	$form->addField(array("lableName" => "Identity Number", "type" => "text", "name" => "identityNumber","value" => $emp->identityNumber, "desc" => "Enter Your Id Number"));
                                	$form->addField(array("lableName" => "Province", "type" => "select", "name" => "province", $emp->province, "desc" => "", "options" => libinc::getCountryData(0), "nested" => true, "mydiv" => "provinceDiv", "calldiv" => "districtDiv", "calledName" => "district", "callbackdiv" => "sectorDiv", "callbackname"=>"sector","fun" => "xajax_getHierachyData"));
                                	$form->addField(array("lableName" => "District", "type" => "select", "name" => "district", $emp->district, "desc" => "", "options" => libinc::getCountryData(-1), "nested" => true, "mydiv" => "districtDiv", "calldiv" => "sectorDiv", "calledName" => "sector", "callbackdiv" =>"cellDiv", "callbackname"=>"cell", "fun" => "xajax_getHierachyData"));
                                	$form->addField(array("lableName" => "Sector", "type" => "select", "name" => "sector", $emp->sector, "desc" => "", "options" => libinc::getCountryData(-1), "nested" => true, "mydiv" => "sectorDiv", "calldiv" => "cellDiv", "calledName" => "cell", "callbackdiv" =>"villageDiv", "callbackname"=>"village", "fun" => "xajax_getHierachyData"));
                                	$form->addField(array("lableName" => "Cell", "type" => "select", "name" => "cell", $emp->cellule, "desc" => "", "options" => libinc::getCountryData(-1), "nested" => true, "mydiv" => "cellDiv", "calldiv" => "villageDiv", "calledName" => "village","callbackdiv" =>"", "callbackname"=>"", "fun" => "xajax_getHierachyData"));
                                	$form->addField(array("lableName" => "Village", "type" => "select", "name" => "village",$emp->village, "desc" => "", "options" => libinc::getCountryData(-1), "nested" => true,"mydiv" => "villageDiv", "calldiv" => "villageDiv", "calledName" => "village", "fun" => "xajax_getHierachyData"));
                                ?>
                                <?=$form->render();?>
                            </div>
                            <!--/ tab-pane: profile -->
			  <!-- employment tab -->
			   ...
			   <?php
			   	$form = new forms(true,true,"POST","staff/employment","Employment","controller","",true);
			   	$form->setHeadings("Employment", "This information appears in the Human Resource and your own page.");
			   	$form->addField(array("lableName" => "Contract Type", "type" => "select", "name" => "contract","value" => "", "desc" => "", "options" => array("Permanent" => "Permanent","contract" => "Contract","part-time" => "Part-time"), "nested" => false));
			   	$form->addField(array("lableName" => "Job Title", "type" => "select", "name" => "jobTitle","value" => "", "desc" => "", "options" => array("accountant" => "Accountant","Lecturer" => "Lecturer","ass-Lecturer" => "Ass-Lecturer"), "nested" => false));
			   	$form->addField(array("lableName" => "Administrative Level", "type" => "select", "name" => "adminLevel","value" => "", "desc" => "", "options" => array("Principle" => "Principle","Vice Principle" => "Vice Principle","Director" => "Director"), "nested" => false));
			   	$form->addField(array("lableName" => "Organization", "type" => "select", "name" => "organization","value" => "", "desc" => "", "options" => libinc::getTableItems("organizations","organizationId","organizationName",""), "nested" => false));
			   	$form->addField(array("lableName" => "Category", "type" => "select", "name" => "category","value" => "", "desc" => "", "options" => array("Teaching Staff" => "Teaching Staff", "Non Teaching Staff" => "Non Teaching Staff"), "nested" => false));
			   	$form->addField(array("lableName" => "Job Id No.", "type" => "text", "name" => "jobIdNo","value" => "", "desc" => ""));
			  ...
			  <!-- qualifications tab -->
			   ...
			   <?php
			   	$form = new forms(true,true,"POST","staff/qualifications","Quafications","controller","",true);
			   	$form->setHeadings("Qualifications", "This information appears in the Human Resource and your own page.");
			   	$form->addField(array("lableName" => "Education Level", "type" => "select", "name" => "","value" => "", "desc" => "", "options" => array("PHD" => "PHD", "Masters" => "Masters","Barchelors" => "Barchelors", "Higher Diploma" => "Higher Diploma", "Diploma" => "Diploma", "HSC" => "High School Certificate" ), "nested" => false));
			   	$form->addField(array("lableName" => "Field Of Study", "type" => "select", "name" => "studyField","value" => "", "desc" => "", "options" => libinc::getTableItems("organizations","organizationId","organizationName",""), "nested" => false));
			   	$form->addField(array("lableName" => "Institution", "type" => "text", "name" => "institution","value" => "", "desc" => ""));
			   	$form->addField(array("lableName" => "Other Qualifications", "type" => "textarea", "name" => "otherQualifications","value" => "", "desc" => "Enter other qualifications, seperated by new line character."));
			   	$form->addField(array("lableName" => "First Name", "type" => "button", "name" => "save", "desc" => "Stupid Button"));
			   ?>
			    <?=$form->render();?>
			   </div>
			  <!-- / end qualifications tab -->
			  
			  <!-- skills tab -->
			   <div class="tab-pane" id="skills">
			   <?php
			   	$form = new forms(true,true,"POST","staff/skills","Skills","controller","",true);
			   	$form->setHeadings("Skiils & Experience", "This information appears in the Human Resource and your own page.");
			   	$form->addField(array("lableName" => "Computer Literacy", "type" => "checkbox", "name" => "computerLiteracy","value" => "", "desc" => ""));
			   	$form->addField(array("lableName" => "First Name", "type" => "button", "name" => "save", "desc" => "Stupid Button"));
			   ?>
			    <?=$form->render();?>
			   </div>
