            ...
            <section class="page-header page-header-block nm">
                ...
                <div class="container pt15 pb15">
                    <div class="page-header-section">
                        <h4 class="title font-alt">Accounts Creation</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <li class="active">Account Registration status</li>
                            </ol>
                        </div>
                        <!--/ Toolbar -->
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="section-header section-header-bordered text-center">
                                <h2 class="section-title">
                                    <p class="font-alt nm">Mobis account created</p>
                                </h2>
                            </div>
                            <!--/ Header -->
                        </div>
                                ...
                                <ul class="list-table pa15">
                                    <li>
                                        ...
                                        <div class="alert alert-success nm">
                                            <span class="semibold">you have successfuly created an account :</span>&nbsp;&nbsp;Please check your email address to confirm<br />After your account has been approved by the Ensibuuko service team, you'll be able to access the system. Please keep checking your email for updates.
                                        </div>
                                        <!--/ Alert message -->
                                    </li>
