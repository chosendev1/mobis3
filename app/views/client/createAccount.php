    ...
    <head>
	 ...
	 <base href="<?=base_url()?>">
        ...
        <link rel="stylesheet" href="resources/themes/admire/plugins/jqueryui/css/jquery-ui.min.css">
            <link rel="stylesheet" href="resources/themes/admire/stylesheet/layout.min1.css">
        ...
        <!-- END STYLESHEETS -->
          ...
          <link rel="stylesheet" href="resources/themes/admire/stylesheet/layout.min.css">
        <link rel="stylesheet" href="resources/themes/admire/stylesheet/uielement.min11.css">
          <link rel="stylesheet" href="resources/themes/admire/stylesheet/styles1.css">
           <link rel="stylesheet" href="resources/themes/admire/stylesheet/style33.css">
                        ...
                        <div class="col-md-8">
                            ...
                            <form class="panel nm" name="form-register" id="form-register" action="client/saveAccount" method="POST" data-parsley-validate>
                                ...
                                <div class="panel-body">
                                     <div class="col-sm-22">
                                        <label class="control-label">Organization/SACCO:</label>
                                        <div class="has-icon pull-left">
                                        <input type="text" class="form-control" name="orgName" dat/SACCO NAMEa-parsley-required>
                               ...
                               <div class="col-sm-6">
                                  ...
                                  <div class="col-sm-6">
                                        ...
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="bank_account" data-parsley-required placeholder="Bank Account No">
                         ...
                         <div class="col-sm-6">
                                        ...
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="region" data-parsley-required>
                               ...
                               <div class="col-sm-6">
                                        ...
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="village" data-parsley-required>
                                        ...
                                        <label class="control-label">Date of  Registeration:</label>
                                        <div class="has-icon pull-left">
                                        ...
                                        <div class="has-icon pull-left">
                                            <input type="file"  name="certificate" id="datepicker4">
                                           
                                        </div>
                                    </div> <div class="col-sm-6">
                                        <label class="control-label">Certificate Number:</label>
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="cno" id="datepicker4">
                                           
                                        </div>
                                    </div> <div class="col-sm-6">
                                        <label class="control-label">Name Of Representative:</label>
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="rname" id="datepicker4">
                                           
                                        </div>
                                    </div> <div class="col-sm-6">
                                        <label class="control-label">Representative's Position:</label>
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="position" id="datepicker4">
                                           
                                        </div>
                                    </div> <div class="col-sm-6">
                                        <label class="control-label">Representative's Phone:</label>
                                        <div class="has-icon pull-left">
                                            <input type="text" class="form-control" name="rphone" id="datepicker4">
                                     ...
                                     <hr class="nm">
                                      <div class="panel-body">
                                       <p class="semibold text-muted">This will be the account you use to access the system for the first time. it'll also be the administrative account for your portal.</p> <div class="col-sm-6">
                                ...
                                <hr class="nm">
                                <div class="panel-body">
                                    <p class="semibold text-muted">To confirm and activate your new account, we will need to send the activation code to your e-mail.</p> <div class="col-sm-6">
            ...
            <div class="container">
				...
				www.ensibuuko.com<br>
                    ...
                    <div class="col-md-4">
                        ...
                        <form role="form"> <div class="col-sm-6">
