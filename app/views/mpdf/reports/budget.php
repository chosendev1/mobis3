...
//queries
function headerfun($from_year,$from_month,$from_mday,$to_year,$to_month,$to_mday){
...
//report name
$reportname = "Budget Report Ending ".$monthName.'-'.$to_year; 
//get company name.
...
<tr><th></th><th>#</th><th width="10%">Budget Item.</th><th width="10%">Budgeted Amount</th><th width="20%">Actual Spent Amount</th><th width="10%"> Budget Balance</th><th width="10%"> Budget %</th><th width="10%">Budgeted YTD</th><th width="10%">Actual YTD</th><th width="15%">Actual YTD Balance</th><th width="20%">Budgeted YTD Balance</th><th width="10%">% Spent YTD</th></tr>
...
$header = '
'.headerfun( $_GET['from_year'], $_GET['from_month'], $_GET['from_mday'], $_GET['to_year'], $_GET['to_month'], $_GET['to_mday']).'<hr>
';
$headerE = '
...
$html = ''.bodyfun( $_GET['from_year'], $_GET['from_month'], $_GET['from_mday'], $_GET['to_year'], $_GET['to_month'], $_GET['to_mday']).'';
