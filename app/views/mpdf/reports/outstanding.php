...
//$from_date = sprintf("%d-%02d-%02d 00:00:00", $from_year, $from_month, $from_mday);
 ...
 // else{
  ...
  // $resp->assign("status", "innerHTML", $cont);
    ...
    $content .= '<table class="bpmTopicC" id="table-tools" width="100%"><tr><th width="5%" align="">No</th><th width="10%" align="">Member</th><th width="10%" align="">Name</th><th width="10%" align="">Sex</th><th width="10%" align=""> Loan Amt</th><th width="10%" align="">Intrest Amt</th><th width="10%" align="">Disbursement Date</th><th width="10%" align="">Expiry Date</th><th width="25%" align="">Total Paid</th><th width="10%" align="">Loan Balance</th><th width="10%" align="">Amount in arrears</th></tr><tr><td colspan="11"><hr></td></tr>';
