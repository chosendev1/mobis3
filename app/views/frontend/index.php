        ...
        <section id="main" role="main">
            ...
            <section id="layerslider" style="width:100%;height:480px;">
                ...
                <div class="ls-slide" data-ls="transition2d:1; slidedelay:8000;">
                    ...
                    <!-- Layer #1 -->
                    <img class="ls-l" style="top:90px;left:68%;" src="resources/themes/admire/image/layerslider/layer/people2.png" data-ls="delayin:1000; easingin:easeOutElastic;">
                    <!--/ Layer #1 -->
                    ...
                    <h1 class="ls-l font-alt" style="top:110px;left:150px;" data-ls="offsetxin:0;durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;">
                        Welcome To <span class="text-primary">InU</span> 
                    </h1>
                    <!--/ Layer #2 -->
                    ...
                    <h4 class="ls-l font-alt thin text-default" style="top:170px;left:150px;width:550px;" data-ls="offsetxin:0; durationin:2000; delayin:2000; easingin:easeOutElastic; rotatexin:90; transformoriginin:50% top 0; offsetxout:-400;">
                        The global goal of the Government of Rwanda is to reduce poverty and in turn to improve the well-being of its population.
                    </h4>
                    <!--/ Layer #3 -->
                    ...
                    <p class="ls-l text-default" style="top:230px;left:150px;width:550px;" data-ls="offsetxin:0; durationin:2000; delayin:2500; easingin:easeOutElastic; rotatexin:90; transformoriginin:50% top 0; offsetxout:-400;">
						...
						Within this context, the mission and vision of IPRC Kigali is to provide
						technical and vocational training at all levels in order to empower
						students and enhance their opportunities for career advancement and success
						in a global economy. IPRC Kigali aspires to be a leading world class institution
						in the provision of Technical Education, producing graduates capable of
						developing and implementing creative technical solutions to identify social and
						industrial needs of Rwanda, the region and International society.
                    </p>
                    <!--/ Layer #4 -->
                ...
                <div class="ls-slide" data-ls="transition2d:1; slidedelay:8000;">
                    ...
                    <!-- Layer #6 -->
                    <img class="ls-l" style="top:20px;left:250px;" src="resources/themes/admire/image/layerslider/layer/iphone-5s.png" data-ls="delayin:2000; easingin:easeOutElastic;">
                    <!--/ Layer #6 -->
                </div>
                <!-- Slide #2 -->
            </section>
            ...
            <section class="section bgcolor-primary">
                <div class="container">
                    <div class="col-sm-9">
                        <h3 class="font-alt text-white mt0">Incase of online application problem, help, guidance or clarification!</h3>
                    </div>
                    <div class="col-sm-3 clearfix">
                        <a href="javascript:void(0);" class="btn btn-outline btn-default text-white pull-right semibold">MAKE A CALL</a>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="section-header section-header-bordered mb15">
                        <h3 class="section-title">
                            <p class="font-alt nm">Stay Connect</p>
                        </h3>
                    </div>
                    <!--/ Header -->
                    <!-- carousel -->
                    <div class="owl-carousel" id="lovely-client">
                        ...
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/aztec.png" alt="Aztec Logo"></a>
                        </div>
                        <!--/ client #1 -->
                        <!-- client #2 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/cisco.png" alt="Cisco Logo"></a>
                        </div>
                        <!--/ client #2 -->
                        <!-- client #3 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/cocacola.png" alt="Cocacola Logo"></a>
                        </div>
                        <!--/ client #3 -->
                        <!-- client #4 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/everyday.png" alt="Everyday Logo"></a>
                        </div>
                        <!--/ client #4 -->
                        <!-- client #5 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/hp.png" alt="HP Logo"></a>
                        </div>
                        <!--/ client #5 -->
                        <!-- client #6 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/natural.png" alt="Natural Logo"></a>
                        </div>
                        <!--/ client #6 -->
                        <!-- client #7 -->
                        <div class="item text-center">
                            <a href="javascript:void(0);"><img src="resources/themes/admire/image/client/shell.png" alt="Shell Logo"></a>
                        </div>
                        <!--/ client #7 -->
                    </div>
                    <!--/ carousel -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>The Integrated Polytechnic Regional Centre (IPRC) Kigali,Kicukiro was initially established by
						the Government of Rwanda in 2008 as "Kicukiro College of Technology (KCT)".</p>
                        <p> The core mission of the college was to develop and provide professional
						technical education at the level of diploma (A1).</p>
                    ...
                    <div class="col-md-4">
                        ...
                        <address>
                            <strong>IPRC KIGALI</strong><br>
                            KICUKIRO DISTRICT NIBOYE SECTOR<br>
                            P.O.Box 6579, Kigali _ Rwanda<br>
                            <abbr title="Phone">Tel:</abbr> +250255120083 / +250788473484 / +250730672302<br>
							E-mail:<a href="mailto:info@iprckigali.ac.rw">info@iprckigali.ac.rw</a><br>
							Website:<a href="www.iprckigali.ac.rw">www.iprckigali.ac.rw</a>
                        </address>
                    ...
                    <div class="col-md-4">
                        ...
                        <form role="form">
                            <div class="form-group">
                                <p class="form-control-static">Subscribe to our newsletter and stay up to date with the latest news!</p>
                            </div>
                            <div class="form-group">
            ...
            <div class="footer-bottom">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- copyright -->
                            <p class="nm text-muted">&copy; Copyright 2014 by <a href="javascript:void(0);" class="text-white">InU</a>. All Rights Reserved.</p>
                            <!--/ copyright -->
                        </div>
