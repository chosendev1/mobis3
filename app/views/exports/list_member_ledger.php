...
function memsavings_ledger($mem_no, $mem_id, $save_acct, $from_year, $from_month, $to_year, $to_month)
{
	...
	$content .= " <br>
		   <center><font color=#00008b size=3pt><B>INTERIM SAVINGS STATEMENT (".$prod['account_no'].")</B></font></center><br>
...
function member_ledger($mem_id, $type, $from_year, $from_month, $from_mday, $to_year, $to_month, $to_mday, $format){
	...
	$content .= " <center><font color=#00008b size=5pt><B>".$branch['branch_name']."</B></font></center><p>
		   ...
		   <table width=70%><tr bgcolor=white><td align=><img src='photos/".$mem_row['photo_name']."?dummy=".time()."' width=90 height=90><br>Photo</td><td align=right><img src='signs/".$mem_row['sign_name']."?dummy=".time()."' width=90 height=90><br>Signature</td></tr></table></p></center>";
	...
	$found_shares = 0;
	$content .= "<center><font color=#00008b size=3pt><b>SHARES </b></font></center><br>";
...
function memloan_ledger($mem_no, $from_year, $from_month, $from_mday, $to_year, $to_month, $to_mday){
	$content .="<br><center><font color=#00008b size=3pt><B>LOAN LEDGER</B></font></center><br><table height=100 border='1' height=100 cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' width='70%' id='AutoNumber2' align=center><tr><td>";
	if($from_year =='')
